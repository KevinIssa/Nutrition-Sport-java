...
//
//public class ProfileModificatorViewController implements ViewController {
//    @FXML
...
//            return;
//        }
//        this.getModel().getController().switchFXML("/ulb/views/menu/Menu.fxml", this.getModel()); // switch to Menu.fxml after saving profile ?
//    }
//
